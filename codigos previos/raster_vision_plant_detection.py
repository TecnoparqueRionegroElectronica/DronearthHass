# -*- coding: utf-8 -*-
"""
Created on Thu Aug  8 12:18:18 2024
...
if __name__ == "__main__":
    ...
    print("Running training and prediction using 'rastervision run local'")

    # Pass IMAGES_DIR to get_config
    subprocess.run(["rastervision", "run", "local", "-m", "config.get_config", "--images-dir", IMAGES_DIR])
