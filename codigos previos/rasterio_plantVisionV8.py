# -*- coding: utf-8 -*-
"""
Created on Tue Aug 20 12:33:49 2024
...
def create_model(input_shape, num_classes=1, use_pretrained=USE_PRETRAINED, trainable_layers=10):
    if use_pretrained:
        ...
        # Calculate Dense layer input size after Flatten
        model.build(input_shape=(None, *input_shape))  # Build the model
        dense_input_size = model.layers[-1].output_shape[1]  # Access output_shape after building
